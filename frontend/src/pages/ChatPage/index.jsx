              ...
              <div className="flex flex-col gap-3.5 m-3.5">
                <div className="relative">
                  <div className="max-h-96 w-full overflow-y-auto font-large break-words transition-opacity duration-200 min-h-[1.5rem]">
                    <textarea
                      ...
                      placeholder="간단한 메모, 핵심 요약, 보도자료 초안 등 어떤 형태로든 입력하세요. 전문 보도자료로 완성해 드립니다"
                ...
                <div className="flex gap-2.5 w-full items-center">
                  ...
                  <div style={{ opacity: 1, transform: "none" }}>
                    <button
                      className={clsx(
                        "inline-flex items-center justify-center relative shrink-0 can-focus select-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:drop-shadow-none font-base-bold transition-colors h-8 w-8 rounded-lg active:scale-95",
